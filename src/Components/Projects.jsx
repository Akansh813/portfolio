        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-[#52526C] mt-2">
              ...
              Communicated in <strong>Neuropharmacology</strong>; Journal of Elsevier; 2020;
              Impact factor: 4.431 (under review).
            </p>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <h3 className="font-bold text-lg text-[#00004B]">Review Article</h3>
            <p className="text-[#52526C] mt-2">
              "Emerging approaches for the treatment of Alzheimer disease:
              Targeting NF-κB pathway." Communicated in <strong>Inflammation</strong>;
              Journal of Springer; 2020; Impact factor: 3.212 (under review).
            </p>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <h3 className="font-bold text-lg text-[#00004B]">Book Chapter</h3>
            <p className="text-[#52526C] mt-2">
              "Digestive system" in Textbook of "Human Anatomy and Physiology-II"
              of B Pharmacy II semester as per new PCI syllabus.
